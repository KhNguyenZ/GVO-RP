...
CMD:seat(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /seat [1-2]");
    }
    return 1;
}
...
CMD:shake(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /shake [1-3]");
    }
    return 1;
}
...
CMD:chat(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /chat [1-7]");
    }
    return 1;
}
...
CMD:gesture(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /gesture [1-15]");
    }
    return 1;
}
...
CMD:lay(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /lay [1-3]");
    }
    return 1;
}
...
CMD:wave(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /wave [1-3]");
    }
    return 1;
}
...
CMD:signal(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /signal [1-2]");
    }
    return 1;
}
...
CMD:nobreath(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /nobreath [1-3]");
    }
    return 1;
}
...
CMD:fallover(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /fallover [1-5]");
    }
    return 1;
}
...
CMD:pedmove(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /pedmove [1-26]");
    }
    return 1;
}
...
CMD:getjiggy(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /getjiggy [1-10]");
    }
    return 1;
}
...
CMD:stripclub(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /stripclub [1-2]");
    }
    return 1;
}
...
CMD:smoke(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /smoke [1-2]");
    }
    return 1;
}
...
CMD:dj(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /dj [1-4]");
    }
    return 1;
}
...
CMD:reload(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /reload [1-2]");
    }
    return 1;
}
...
CMD:tag(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /tag [1-2]");
    }
    return 1;
}
...
CMD:crossarms(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /crossarms [1-4]");
    }
    return 1;
}
...
CMD:cheer(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /cheer [1-8]");
    }
    return 1;
}
...
CMD:sit(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /sit [1-5]");
    }
    return 1;
}
...
CMD:siteat(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /siteat [1-2]");
    }
    return 1;
}
...
CMD:bar(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /bar [1-5]");
    }
    return 1;
}
...
CMD:spank(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /spank [1-4]");
    }
    return 1;
}
...
CMD:sexy(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /sexy [1-6]");
    }
    return 1;
}
...
CMD:holdup(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /holdup [1-2]");
    }
    return 1;
}
...
CMD:copa(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /copa [1-9]");
    }
    return 1;
}
...
CMD:snatch(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /snatch [1-2]");
    }
    return 1;
}
...
CMD:blowjob(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /blowjob [1-2]");
    }
    return 1;
}
...
CMD:idles(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /idles [1-15]");
    }
    return 1;
}

CMD:lie(playerid, params[])
{
    if (!IsAblePedAnimation(playerid)) return 1;
    switch (strval(params))
    {
        case 1: PlayAnimEx(playerid, "MD_END", "END_SC1_PLY", 4.1, 0, 1, 1, 1, 1, 1);
        case 2: PlayAnimEx(playerid, "MD_END", "END_SC1_RYD", 4.1, 0, 1, 1, 1, 1, 1);
        case 3: PlayAnimEx(playerid, "MD_END", "END_SC1_SMO", 4.1, 0, 1, 1, 1, 1, 1);
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /lie [1-3]");
    }
    return 1;
}
...
CMD:sunbathe(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /sunbathe [1-18]");
    }
    return 1;
}
...
CMD:lowrider(playerid, params[])
{
    ...
    if (IsCLowrider(GetPlayerVehicleID(playerid)))
    {
        switch (strval(params))
        {
            ...
            default:
                SendClientMessage(playerid, COLOR_WHITE, "USAGE: /lowrider [1-31]");
        }
    }
    else
    {
...
CMD:carchat(playerid, params[])
{
    ...
    switch (strval(params))
    {
        ...
        default:
            SendClientMessage(playerid, COLOR_WHITE, "USAGE: /carchat [1-19]");
    }
    return 1;
}
