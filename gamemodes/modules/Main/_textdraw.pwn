func:CreateHienTextDraw(playerid)
{
    ...
    PlayerTextDrawColour(playerid, scm_PTD[playerid], -1);
    PlayerTextDrawSetOutline(playerid, scm_PTD[playerid], 0);
    PlayerTextDrawBackgroundColour(playerid, scm_PTD[playerid], 255);
...
func:CreateFadeEffectTextDraw(playerid)
{
	...
	PlayerTextDrawColour(playerid, FadeEffect[playerid][0], 187);
	PlayerTextDrawSetShadow(playerid, FadeEffect[playerid][0], 0);
	PlayerTextDrawSetOutline(playerid, FadeEffect[playerid][0], 0);
	PlayerTextDrawBackgroundColour(playerid, FadeEffect[playerid][0], 255);
...
func:CreateInfo()
{
    ...
    TextDrawColour(InfoTD[0], 255);
    TextDrawSetShadow(InfoTD[0], 0);
    TextDrawSetOutline(InfoTD[0], 0);
    TextDrawBackgroundColour(InfoTD[0], 255);
    ...
    TextDrawColour(InfoTD[1], 255);
    TextDrawSetShadow(InfoTD[1], 0);
    TextDrawSetOutline(InfoTD[1], 0);
    TextDrawBackgroundColour(InfoTD[1], 0);
    ...
    TextDrawColour(InfoTD[2], -1);
    TextDrawSetShadow(InfoTD[2], 0);
    TextDrawSetOutline(InfoTD[2], 0);
    TextDrawBackgroundColour(InfoTD[2], 255);
...
func:CreatePlayerInfo(playerid)
{
    ...
    PlayerTextDrawColour(playerid, InfoPTD[playerid][0], 255);
    PlayerTextDrawSetShadow(playerid, InfoPTD[playerid][0], 0);
    PlayerTextDrawSetOutline(playerid, InfoPTD[playerid][0], 0);
    PlayerTextDrawBackgroundColour(playerid, InfoPTD[playerid][0], 0);
    ...
    PlayerTextDrawColour(playerid, InfoPTD[playerid][1], 255);
    PlayerTextDrawSetShadow(playerid, InfoPTD[playerid][1], 0);
    PlayerTextDrawSetOutline(playerid, InfoPTD[playerid][1], 0);
    PlayerTextDrawBackgroundColour(playerid, InfoPTD[playerid][1], -1);
