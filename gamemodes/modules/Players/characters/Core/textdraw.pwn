...
hook OnPlayerConnect(playerid)
{
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][0], 255);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][1], 255);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][2], 255);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][3], 255);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][4], 255);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][5], 255);
	...
	PlayerTextDrawColor(playerid, SelectCharPTD[playerid][7], -1);
	PlayerTextDrawSetShadow(playerid, SelectCharPTD[playerid][7], 0);
	PlayerTextDrawSetOutline(playerid, SelectCharPTD[playerid][7], 0);
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][7], 150);
	...
	PlayerTextDrawColor(playerid, SelectCharPTD[playerid][8], -1);
	PlayerTextDrawSetShadow(playerid, SelectCharPTD[playerid][8], 0);
	PlayerTextDrawSetOutline(playerid, SelectCharPTD[playerid][8], 0);
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][8], 150);
	...
	PlayerTextDrawColor(playerid, SelectCharPTD[playerid][9], -1);
	PlayerTextDrawSetShadow(playerid, SelectCharPTD[playerid][9], 0);
	PlayerTextDrawSetOutline(playerid, SelectCharPTD[playerid][9], 0);
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][9], 85);
	...
	PlayerTextDrawSetPreviewVehCol(playerid, SelectCharPTD[playerid][9], 0, 0);
	...
	PlayerTextDrawColor(playerid, SelectCharPTD[playerid][10], -1);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][10], 85);
	...
	PlayerTextDrawSetPreviewVehCol(playerid, SelectCharPTD[playerid][10], 0, 0);
	...
	PlayerTextDrawColor(playerid, SelectCharPTD[playerid][11], -1);
	...
	PlayerTextDrawBackgroundColor(playerid, SelectCharPTD[playerid][11], 85);
	...
	PlayerTextDrawSetPreviewVehCol(playerid, SelectCharPTD[playerid][11], 0, 0);
...
func:CreateActorSelect(playerid)
{
	SwitchCharacter(playerid, 1,
	Character[playerid][char_last_Pos][0],
	Character[playerid][char_last_Pos][1],
	Character[playerid][char_last_Pos][2],
	Character[playerid][char_last_Pos][3]
	);
}
