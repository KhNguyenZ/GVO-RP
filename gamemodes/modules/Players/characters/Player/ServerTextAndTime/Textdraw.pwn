...
hook OnGameModeInit()
{
	...
	TextDrawColour(LSRP[0], -1448498689);
	TextDrawSetShadow(LSRP[0], 0);
	TextDrawSetOutline(LSRP[0], 1);
	TextDrawBackgroundColour(LSRP[0], 150);
...
hook OnPlayerConnect(playerid)
{
	...
	PlayerTextDrawColour(playerid, LSRPTime[playerid][0], -1061109505);
	PlayerTextDrawSetShadow(playerid, LSRPTime[playerid][0], 0);
	PlayerTextDrawSetOutline(playerid, LSRPTime[playerid][0], 1);
	PlayerTextDrawBackgroundColour(playerid, LSRPTime[playerid][0], 150);
	...
	PlayerTextDrawColour(playerid, LSRPTime[playerid][1], -1061109505);
	PlayerTextDrawSetShadow(playerid, LSRPTime[playerid][1], 0);
	PlayerTextDrawSetOutline(playerid, LSRPTime[playerid][1], 1);
	PlayerTextDrawBackgroundColour(playerid, LSRPTime[playerid][1], 150);
