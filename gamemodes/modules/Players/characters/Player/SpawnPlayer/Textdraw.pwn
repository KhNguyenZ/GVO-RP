...
hook OnPlayerConnect(playerid)
{
	...
	PlayerTextDrawColour(playerid, SpawnLSRP[playerid][0], -1);
	PlayerTextDrawSetShadow(playerid, SpawnLSRP[playerid][0], 0);
	PlayerTextDrawSetOutline(playerid, SpawnLSRP[playerid][0], 0);
	PlayerTextDrawBackgroundColour(playerid, SpawnLSRP[playerid][0], 255);
	...
	PlayerTextDrawColour(playerid, SpawnLSRP[playerid][1], -1);
	PlayerTextDrawSetShadow(playerid, SpawnLSRP[playerid][1], 0);
	PlayerTextDrawSetOutline(playerid, SpawnLSRP[playerid][1], 0);
	PlayerTextDrawBackgroundColour(playerid, SpawnLSRP[playerid][1], 255);
	...
	PlayerTextDrawColour(playerid, SpawnLSRP[playerid][2], -1);
	PlayerTextDrawSetShadow(playerid, SpawnLSRP[playerid][2], 0);
	PlayerTextDrawSetOutline(playerid, SpawnLSRP[playerid][2], 0);
	PlayerTextDrawBackgroundColour(playerid, SpawnLSRP[playerid][2], 255);
	...
	PlayerTextDrawColour(playerid, SpawnLSRP[playerid][3], -1);
	PlayerTextDrawSetShadow(playerid, SpawnLSRP[playerid][3], 0);
	PlayerTextDrawSetOutline(playerid, SpawnLSRP[playerid][3], 0);
	PlayerTextDrawBackgroundColour(playerid, SpawnLSRP[playerid][3], 255);
