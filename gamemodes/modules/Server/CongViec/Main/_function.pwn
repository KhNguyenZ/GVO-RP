...
public TimerVehRent(_veh_rent_id)
{
    ...
    else if (Veh_Rent[_rentid][job_traxe] == 1)
    {
        ...
        Veh_Rent[_rentid][job_id] = INVALID_NUMBER;
        Veh_Rent[_rentid][job_renter] = INVALID_NUMBER;
        Veh_Rent[_rentid][job_modelid] = INVALID_NUMBER;
        Veh_Rent[_rentid][job_vehid] = INVALID_NUMBER;
