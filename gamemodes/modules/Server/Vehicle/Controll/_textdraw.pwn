...
func:CreatePlayerControll(playerid){
    ...
    PlayerTextDrawColour(playerid, VehControllPTD[playerid][0], -1);
    PlayerTextDrawBackgroundColour(playerid, VehControllPTD[playerid][0], 255);
    PlayerTextDrawBoxColour(playerid, VehControllPTD[playerid][0], 50);
    ...
    PlayerTextDrawColour(playerid, VehControllPTD[playerid][1], -1);
    PlayerTextDrawBackgroundColour(playerid, VehControllPTD[playerid][1], 255);
    PlayerTextDrawBoxColour(playerid, VehControllPTD[playerid][1], 50);
    ...
    PlayerTextDrawColour(playerid, VehControllPTD[playerid][2], -1);
    PlayerTextDrawBackgroundColour(playerid, VehControllPTD[playerid][2], 255);
    PlayerTextDrawBoxColour(playerid, VehControllPTD[playerid][2], 50);
    ...
    PlayerTextDrawColour(playerid, VehControllPTD[playerid][3], -1);
    PlayerTextDrawBackgroundColour(playerid, VehControllPTD[playerid][3], 255);
    PlayerTextDrawBoxColour(playerid, VehControllPTD[playerid][3], 50);
