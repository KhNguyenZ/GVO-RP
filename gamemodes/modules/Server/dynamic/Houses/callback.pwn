...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    if(dialogid == DIALOG_HOUSE+2)
    {
        ...
        if(id == INVALID_HOUSE_ID) return SendClientMessage(playerid, 0xE74C3CFF, "He Thong House: Ban khong o trong mot ngoi nha nao.");
        GetPlayerName(playerid, name, MAX_PLAYER_NAME);
    ...
    if(dialogid == DIALOG_HOUSE+11)
    {
        ...
        if(listitem == 0)
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_HOUSE+12, DIALOG_STYLE_LIST, "Mua Noi That", list, "Mua", "Tro Ve");
        }
